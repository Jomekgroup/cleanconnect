...
const LoginTab: React.FC<LoginTabProps> = ({ email, setEmail, password, setPassword, handleLogin, onForgotPasswordClick }) => {
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleLogin(); }}>
         ...
         <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
                <button disabled className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 cursor-not-allowed opacity-50"><span className="sr-only">Sign in with Google</span><GoogleIcon /></button>
                <button disabled className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 cursor-not-allowed opacity-50"><span className="sr-only">Sign in with Apple</span><AppleIcon /></button>
            </div>
        </div>
    </div>
    );
...
const SignupTab: React.FC<SignupTabProps> = ({ onInitialSignup }) => {
        ...
        <div>
            <form onSubmit={handleSubmit}>
             ...
             <div className="mt-6">
                ...
                <div className="mt-6 grid grid-cols-2 gap-3">
                    <button disabled className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 cursor-not-allowed opacity-50"><span className="sr-only">Sign up with Google</span><GoogleIcon /></button>
                    <button disabled className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 cursor-not-allowed opacity-50"><span className="sr-only">Sign up with Apple</span><AppleIcon /></button>
                </div>
            </div>
        </div>
    );
...
export const Auth: React.FC<AuthProps> = ({ initialTab, onNavigate, onLoginAttempt, onInitialSignup, authMessage, onAuthMessageDismiss }) => {
                    ...
                    <div className="bg-white p-8 sm:p-10 rounded-xl shadow-lg">
                        ...
                        {loginView === 'form' ? (
                            activeTab === 'login' ? (
                                ...
                                <SignupTab onInitialSignup={onInitialSignup} />
                            )
                        ) : (
